...
from app.schemas.dashboard import CategoryBreakdown, MonthlySummary
...
async def spending_by_category(
    ...
    """Expense breakdown by category for a month (default: current), largest first."""
    today = date.today()
    return await transaction_service.spending_by_category(
        db, current_user.id, year=year or today.year, month=month or today.month
    )
